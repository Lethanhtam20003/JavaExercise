...
public class ConsInventory implements Inventory {
	...
	/**
	 * Develop the method isBelow, which checks whether all 
	 * of the prices of toys in inventory are below the 
	 * threshold.
	 */
	@Override
	...
	public double sumPrice() {
 	...
 	/**
 	 * Define the method averagePrice. It computes the
	 * average price of toys in Inventory. The average is the
	 * total of all prices divided by the number of toys
 	 */
	@Override
	...
	/**
	 * Develop the method replaceName, which consumes
	 * a list of toy and replaces all occurrences of “robot” with
	 * “r2d2” and otherwise retains the toy descriptions in the
	 * same order.
	 */
	@Override
	...
	/**
	 * Develop the method eliminate. The method
	 * consumes a string, called toyOfName and produces a list
	 * of toys that contains all components of list with the
	 * exception of the toy whose name matches toyOfName.
	 */
	@Override

...
public class view extends JFrame {
	...
	public view() {
		...
		//JMenu jmenufont = new JMenu();

		JMenuItem jbutton_undo = new JMenuItem("undo");
		JMenuItem jbutton_redo = new JMenuItem("redo");
		JMenuItem copy = new JMenuItem("copy");
		JMenuItem cut = new JMenuItem("cut");
		JMenuItem past = new JMenuItem("past");

		//jmenufont.add(jbutton_undo);
		//jmenufont.add(jbutton_redo);
		...
		this.add(jpopupMenu);
		// ac mouces listener
		chuotphai ac1 = new chuotphai(this);
